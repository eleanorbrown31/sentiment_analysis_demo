            ...
            if st.button("Analyse", key="single_analyse_btn") and user_input:
                try:  # Add try-except block to prevent code from displaying
                    ...
                    if prediction:
                        ...
                        # Replace the word importance display code with this more robust version
# Look for this section in the single prediction tab
...
# Show important words
    ...
    # Create a more robust HTML structure with proper nesting
                        word_html = "<div style='display: flex; flex-wrap: wrap; gap: 5px;'>"
        ...
        # Add each word span with properly closed tags
        word_html += f"""
    ...
    # Properly close the containing div
    word_html += "</div>"
